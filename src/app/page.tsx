      ...
      <main className="p-4" role="main">
        <div className="mx-auto max-w-7xl">
          ...
          <section className="gap-4 grid grid-cols-1 lg:grid-cols-2 mb-4" aria-label="YAML Processing Interface">
            ...
            {/* Right Column - Output */}
            <article className="relative bg-white shadow-md p-4 rounded-lg" aria-label="Translated Output Section">
              {isProcessing && (
                <div className="z-10 absolute inset-0 flex justify-center items-center bg-white bg-opacity-75 rounded-lg">
                  <div className="text-center">
                    <Spinner size="lg" className="mx-auto mb-4 text-blue-600" />
                    <p className="font-medium text-gray-600">Processing translation...</p>
